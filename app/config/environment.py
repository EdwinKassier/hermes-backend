...
def load_environment():
    ...
    return {
        ...
        'BASE_PROMPT': environ.get('BASE_PROMPT', ''),  # Hermes persona (default/backward compatible)
        'PRISMA_BASE_PROMPT': environ.get('PRISMA_BASE_PROMPT', ''),
        'PRISM_BASE_PROMPT': environ.get('PRISM_BASE_PROMPT', ''),  # Prism voice agent persona
        # Prism Domain Configuration (Attendee Voice Agent Integration)
        'ATTENDEE_API_KEY': environ.get('ATTENDEE_API_KEY'),
        'WEBHOOK_BASE_URL': environ.get('WEBHOOK_BASE_URL'),  # Base URL for webhooks (e.g., https://your-domain.com)
        'WEBSOCKET_BASE_URL': environ.get('WEBSOCKET_BASE_URL'),  # Base URL for WebSocket (e.g., wss://your-domain.com)
    }
