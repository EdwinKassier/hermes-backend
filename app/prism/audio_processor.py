...
from .constants import AUDIO_BIT_DEPTH, AUDIO_CHANNELS, AUDIO_SAMPLE_RATE
...
class AudioProcessor:
    ...
    @staticmethod
    def convert_to_pcm(audio_data: bytes, source_format: str = "mp3") -> bytes:
        """
        ...
        try:
            ...
            audio.export(
                pcm_buffer, format="s16le"  # Raw PCM format, no codec parameter needed
            )
    ...
    @staticmethod
    def split_into_chunks(pcm_data: bytes, chunk_size: int = 4096) -> List[bytes]:
        """
    ...
    @classmethod
    def process_tts_audio(cls, tts_audio: bytes, source_format: str = "mp3") -> dict:
        """
