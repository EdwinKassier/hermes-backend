"""
Unit tests for Prism signal handling in multi-threaded environments.

These tests verify that PrismService can be instantiated from worker threads
...
class TestPrismSignalHandling:
    ...
    def test_get_prism_service_from_worker_thread(self):
        """Test that get_prism_service works from worker thread."""
        result = {}
        exception = None
    ...
    def test_multiple_threads_instantiate_prism_service(self):
        """Test that multiple threads can instantiate PrismService simultaneously."""
        results = []
        exceptions = []
