...
from app.hermes.exceptions import (
    InvalidRequestError, AIServiceError, TTSServiceError, HermesServiceError
)
...
def hermes_service():
    ...
    with patch('app.hermes.services.get_gemini_service') as mock_gemini_getter, \
...
class TestProcessRequest:
    ...
    def test_process_request_text_mode(self, hermes_service, user_identity):
        ...
        hermes_service.gemini_service.generate_gemini_response_with_rag.return_value = "AI response"
    ...
    def test_process_request_tts_error(self, hermes_service, user_identity):
        ...
        hermes_service.gemini_service.generate_gemini_response_with_rag.return_value = "Response"
...
class TestChat:
    ...
    def test_chat_returns_gemini_response(self, hermes_service, user_identity):
        ...
        hermes_service.gemini_service.generate_gemini_response_with_rag.return_value = "Test response"
...
class TestGenerateTTS:
    ...
    def test_generate_tts_error(self, hermes_service):
        ...
        hermes_service.tts_service.generate_audio.side_effect = ValueError("Invalid input")
...
class TestServiceSingleton:
    ...
    def test_get_hermes_service_singleton(self):
        ...
        with patch('app.hermes.services.get_gemini_service'), \
