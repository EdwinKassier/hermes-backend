...
class TestUserIdentity:
    ...
    def test_user_identity_defaults(self):
        ...
        identity = UserIdentity(
            user_id="test_user", ip_address="127.0.0.1", user_agent="test"
        )
...
class TestGeminiResponse:
    ...
    def test_gemini_response_optional_fields(self):
        ...
        response = GeminiResponse(
            content="Response", user_id="user_123", prompt="Prompt"
        )
...
class TestProcessRequestResult:
    ...
    def test_result_creation_text_mode(self):
        ...
        result = ProcessRequestResult(
            message="Test response", response_mode=ResponseMode.TEXT, user_id="user_123"
        )
    ...
    def test_result_timestamp_auto_generated(self):
        ...
        result = ProcessRequestResult(
            message="Response", response_mode=ResponseMode.TEXT, user_id="user_123"
        )
...
class TestTTSResponse:
    ...
    def test_tts_response_defaults(self):
        """Test default values"""
        response = TTSResponse(text="Test", audio_url="https://example.com/audio")
        assert response.format == "wav"
